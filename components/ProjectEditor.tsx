...
import { 
  ...
  Upload, Loader2, MapPin, FileText, Users, Calendar, Eye, Timer, Music, Briefcase, History, PenTool, Archive, RefreshCw
} from 'lucide-react'; // 👈 J'ai ajouté Archive et RefreshCw
...
export default function ProjectEditor({ project, isSuperAdmin, staffList, user }: { project: Project, isSuperAdmin: boolean, staffList: string[], user: any }) {
  ...
  const toggleArchive = async () => {
      if(!confirm(localData.isArchived ? "Réactiver ce dossier ?" : "Clôturer et archiver ce dossier ? Il disparaîtra de la liste principale.")) return;
      ...
      setIsExpanded(false); // On ferme la carte car elle va probablement changer de liste
  };
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div><label className="text-[10px] uppercase font-bold text-stone-400">Salle</label><input disabled={!canEdit} className="w-full p-2 border rounded bg-stone-50" placeholder="Château de..." value={localData.weddingVenue || ''} onChange={e=>updateField('weddingVenue', e.target.value)} /></div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div><label className="text-[10px] uppercase font-bold text-stone-400">Adresse</label><input disabled={!canEdit} className="w-full p-2 border rounded bg-stone-50" placeholder="12 rue..." value={localData.clientAddress || ''} onChange={e=>updateField('clientAddress', e.target.value)} /></div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="text-[10px] uppercase font-bold text-stone-400">Responsable Dossier</label>
                                ...
                                <div>
                                    <label className="text-[10px] uppercase font-bold text-stone-400">Email Responsable</label>
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-2">
                                    <div>
                                        <label className="text-[10px] uppercase font-bold text-stone-400">Photographe</label>
                                    ...
                                    <div>
                                        <label className="text-[10px] uppercase font-bold text-stone-400">Vidéaste</label>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
                            ...
                            <div className="mb-6 pb-6 border-b border-stone-100">
                                ...
                                <div className="flex gap-2 items-center">
                                    <div className="w-1/3"><label className="text-[10px] font-bold text-stone-400">PRÉVU</label><input disabled={!canEdit} type="date" className="w-full p-2 border rounded text-xs bg-yellow-50 border-yellow-200" value={localData.estimatedDeliveryPhoto || ''} onChange={e=>updateField('estimatedDeliveryPhoto', e.target.value)}/></div>
                                    <div className="flex-1"><label className="text-[10px] font-bold text-stone-400">LIEN</label><input disabled={!canEdit} className="w-full p-2 border rounded text-xs" placeholder="https://..." value={localData.linkPhoto || ''} onChange={e=>updateField('linkPhoto', e.target.value)}/></div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="flex gap-2 items-center">
                                    <div className="w-1/3"><label className="text-[10px] font-bold text-stone-400">PRÉVU</label><input disabled={!canEdit} type="date" className="w-full p-2 border rounded text-xs bg-yellow-50 border-yellow-200" value={localData.estimatedDeliveryVideo || ''} onChange={e=>updateField('estimatedDeliveryVideo', e.target.value)}/></div>
                                    <div className="flex-1"><label className="text-[10px] font-bold text-stone-400">LIEN</label><input disabled={!canEdit} className="w-full p-2 border rounded text-xs" placeholder="https://..." value={localData.linkVideo || ''} onChange={e=>updateField('linkVideo', e.target.value)}/></div>
                                </div>
                            </div>
                        </div>
